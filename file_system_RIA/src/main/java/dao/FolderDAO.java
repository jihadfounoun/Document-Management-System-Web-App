...
public class FolderDAO {
	...
	public void deleteFolderById(int id) throws SQLException {

		PreparedStatement statement = null;
		String query = "DELETE FROM document_management_system.folder WHERE id= ? ";
	...
	public void deleteChildDocuments(int id) throws SQLException {
		DocumentDAO documentDao = new DocumentDAO(connection);
		documentDao.deleteDocumentsByParenteFolderId(id);
	}
